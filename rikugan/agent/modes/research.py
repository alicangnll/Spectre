...
- `save_memory`: Persist confirmed findings to SPECTRA.md for future sessions.
...
Use `save_memory` to persist confirmed findings to SPECTRA.md so future sessions \
